                                      ...
                                      <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" name="cboconsumous" id="cboconsumous" data-live-search="true" data-size="5" required>
                                            </select>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                          <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                              <input class="form-control vld" type="text" id="txtusuario" name="txtusuario" required>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
