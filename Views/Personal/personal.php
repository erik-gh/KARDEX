                                        ...
                                        <div class="row">
                                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                              ...
                                              <select class="form-control" name="cbogerencia" id="cbogerencia" data-live-search="true" data-size="5" required>
                                              </select>
                                            </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-xs-12 col-sm-1 col-md-12 col-lg-12 z-9">
                                          <div class="form-group">
                                            <label>Fecha De Ingreso</label>
                                             <input class="form-control" type="date" id="txtfechadeingreso" name="txtfechadeingreso">
                                          </div>
                                        </div>
