        ...
        <div class="clearfix">
          <div class="text-center m-t-20">
            <a class="authentication-logo" href="#">
              <img src="<?= media();?>/images/logo.png" alt="" height="130">
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
          <div class="authentication-content m-b-20">
            <h3 class="m-t-0 m-b-30 text-center text-success"><b><?= $data['page_tag'] ?></b></h3>
            <form id="form_login" method="POST" autocomplete="off">
              ...
              <button type="submit" class="btn btn-success btn-block" id="enviar"><i class="zmdi zmdi-lock zmdi-hc-fw m-r-5"></i><span> INGRESAR</span></button>
              <div  class="text-center m-t-20">            
