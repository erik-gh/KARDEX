	...
	class Modulo extends Controllers
	{
		...
		public function getModulos()
		{
			...
			for ($i=0; $i <  count($arrData[0]); $i++) { 
				...
				$arrData[0][$i]['icono']	= 	'<span class="menu-icon"><i class="zmdi zmdi-'.$arrData[0][$i]['icono'].'" style="font-size:24px;"></i></span>';
				...
				$arrData[0][$i]['opciones'] =	'<a data-toggle="modal" href="#modal_modulo" class="btn btn-primary btn-xs" title="Editar" onclick="editarModulo('.$arrData[0][$i]['id_modulo'].')">
